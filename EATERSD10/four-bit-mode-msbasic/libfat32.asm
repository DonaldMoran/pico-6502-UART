...
.segment "ZEROPAGE" 
.export  fat32_filenamepointer
fat32_filenamepointer =  $25  ; WOZMON ZERO PAGE, FINE TO USE
;fat32_filenamepointer =  $F5  ; INTERFERES WITH KRUSADER
;fat32_filenamepointer =  $26                                ; Left this one to avoid modifying code, seems ok.
;zp_fat32_variables = $46 ; 49 bytes 

.segment "BSS" 
.export zp_fat32_variables, fat32_workspace
;zp_fat32_variables = $3C00 ; Allocate right before workspace
zp_fat32_variables = $3DB7 ; Allocate right before workspace
fat32_workspace = $3E00 ; Place at highest boundary before $3FFF 


;fat32_workspace = $4E00 ; 2 pages 
;.export zp_fat32_variables, fat32_workspace
;.export  fat32_filenamepointer
;fat32_filenamepointer =  $26                                ; Left this one to avoid modifying code, seems ok.
;zp_fat32_variables = $200                                   ; New start point to avoid issues with BASIC zeropage variables
.segment "CODE"
fat32_readbuffer = fat32_workspace

.export  fat32_fatstart
fat32_fatstart                  = zp_fat32_variables + $00  ; 4 bytes
.export  fat32_datastart
fat32_datastart                 = zp_fat32_variables + $04  ; 4 bytes
.export  fat32_rootcluster
fat32_rootcluster               = zp_fat32_variables + $08  ; 4 bytes
.export  fat32_sectorspercluster
fat32_sectorspercluster         = zp_fat32_variables + $0c  ; 1 byte
.export  fat32_pendingsectors
fat32_pendingsectors            = zp_fat32_variables + $0d  ; 1 byte
.export  fat32_address
fat32_address                   = zp_fat32_variables + $0e  ; 2 bytes
.export  fat32_nextcluster
fat32_nextcluster               = zp_fat32_variables + $10  ; 4 bytes
.export fat32_bytesremaining
fat32_bytesremaining            = zp_fat32_variables + $14  ; 4 bytes           
.export fat32_lastfoundfreecluster
fat32_lastfoundfreecluster      = zp_fat32_variables + $18  ; 4 bytes
.export  fat32_lastcluster
fat32_lastcluster               = zp_fat32_variables + $1c  ; 4 bytes
.export  fat32_lastsector
fat32_lastsector                = zp_fat32_variables + $21  ; 4 bytes
;.export  fat32_filenamepointer
;fat32_filenamepointer           = zp_fat32_variables + $26  ; 2 bytes
.export  fat32_numfats
fat32_numfats                   = zp_fat32_variables + $28  ; 1 byte
.export  fat32_filecluster
fat32_filecluster               = zp_fat32_variables + $29  ; 4 bytes
.export  fat32_sectorsperfat
...
sectorincrementdone2:
  rts

.export fat32_readdirent
fat32_readdirent:
...
fat32_file_readbyte:
  ...
  jsr fat32_readnextsector
  bcs return_subroutine                    ; this shouldn't happen
...
done_fat32_file_read:
  rts

.export fat32_file_write
fat32_file_write:
