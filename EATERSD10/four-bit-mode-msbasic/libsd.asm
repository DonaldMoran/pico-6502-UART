...
.export zp_sd_address, zp_sd_currentsector
...
bitnotset:
  ...
  bcs loop_sd_readbyte       ; loop if we need to read more bits
...
sendbit:
  ...
  dex
  bne loop_sd_writebyte       ; loop if there are more bits to send
